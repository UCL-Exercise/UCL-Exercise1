...
public class EmployeeController {
	...
	@RequestMapping(value = "/employeeInfo_result", method = RequestMethod.POST)
	public String employeeInfo_result(EmployeeForm form, Model model) {
		
		List<EmployeeEntity> list = service.getResultInfo(form.getName(),form.getSkill(),form.getAddress(),form.getExp_year());		
		model.addAttribute("list", list);
